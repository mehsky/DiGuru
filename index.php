...
<div class="wrapper">    
            ...
            <ul>
                ...
                <li class="revolution-mch-1" data-transition="fade" data-slotamount="5" data-masterspeed="1000" data-title="Slide 1">
                    ...
                    <div class="tp-caption re-text-v1 sft"
                        ...
                        style="z-index: 6">
                        Here at DiGuru, we offer compelling and quality online instruction and IT consulting anywhere that you are. 
                    </div>
                    <!-- END LAYER -->                    
                ...
                <li class="revolution-mch-1" data-transition="fade" data-slotamount="5" data-masterspeed="1000" data-title="Slide 2">
                    ...
                    <div class="tp-caption re-text-v1 sft"
                        ...
                        data-captionhidden="off"
                        style="z-index: 6">
                        DiGuru specializes in delivering live Instructor-Led On-Line training.
                    </div>
                ...
                <li class="revolution-mch-1" data-transition="fade" data-slotamount="5" data-masterspeed="1000" data-title="Slide 3">
                    ...
                    <div class="tp-caption re-text-v2 sft start"
                        ...
                        data-endeasing="Power1.easeIn"                        
                        data-endspeed="300">
                        At DiGuru, we seek to bring the best and most efficient solutions to your problems. 
                    </div>
    ...
    <div class="container content-sm">
        <div class="text-center margin-bottom-50">
            <h2 class="title-v2 title-center">We are DiGuru</h2>
            <p class="space-lg-hor">We use the latest <span class="color-green">technologies</span> to deliver a highly interactive learning experience in live online environments, allowing students to learn where ever they are. We also bring the latest technologies to <span class="color-green">your</span> IT projects with our consulting services to help you adapt your company to the dynamic industries that you work in.</p>
        </div>
        ...
        <div class="row content-boxes-v4">
            <div class="col-md-4 md-margin-bottom-40">
                ...
                <div class="content-boxes-in-v4">
                    <h2>Pursue Knowledge <small>Anywhere</small></h2>
                    <p>We use the latest technologies to deliver a highly interactive learning experience. Instructor and students assemble in a Virtual Classroom wherein the students see the teacher's screen and interact with the teacher to ask questions.</p>
                    <!--<a href="#">Learn More</a>-->
                </div>
            </div>
            <div class="col-md-4 md-margin-bottom-40">
                ...
                <div class="content-boxes-in-v4">
                    <h2>Consulting <small>Anywhere</small></h2>
                    <p>We bring IT knowledge that is grounded in practical design and user friendly systems with a cost efficient approach. Let us help alleviate the distraction of an IT project that will take away from your productive work environment and can end up costing you money and fall short without help.</p>
                    <!--<a href="#">Learn More</a>-->
                </div>
            </div>
            <div class="col-md-4">
                ...
                <div class="content-boxes-in-v4">
                    <h2>Leading Projects <small>Anywhere</small></h2>
                    <p>We are constantly pushing the boundries of technologies. Our special projects help us grow in our knowledge, so that we can bring new solutions and ideas to the problems we face today. When standard practices fail, we find real solutions on the cutting edge of technology.</p>
                    <!--<a href="#">Learn More</a>-->
                </div>
            </div>
        </div>
    ...
    <div class="parallax-counter-v1 parallaxBg"> <!--Counters-->
        <div class="container">
            <h2 class="title-v2 title-light title-center">HOW WE GOT HERE</h2>
            ...
            <div class="row margin-bottom-10">
                <div class="col-sm-3 col-xs-6">
                    <div class="counters">
                        <span class="counter">29565</span>   
                        <h4>Cups of Cofee</h4>
                    </div>    
                </div>
                <div class="col-sm-3 col-xs-6">
                    <div class="counters">
                        <span class="counter">5616</span> 
                        <h4>Projects</h4>
                    </div>    
                </div>
                <div class="col-sm-3 col-xs-6">
	...
	<div class="container content-sm">
        <div class="text-center margin-bottom-50">
            <h2 class="title-v2 title-center">Contact Us</h2>
            <h3 class="space-lg-hor"><a href="mailto:hi@ondiguru.com?Subject=Inquiry" target="_top">hi@ondiguru.com</a></h3>
        </div>
    </div>
